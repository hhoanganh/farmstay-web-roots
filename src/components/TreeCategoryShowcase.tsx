        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
          <div className="w-full md:w-3/5 z-0">
            <ImageWrapper 
              ...
              className="w-full max-w-sm mx-auto transform rotate-1 transition-transform duration-300"
            />
          </div>
          <div className="w-full md:w-3/5 md:-ml-24 z-10 -translate-x-2 md:translate-x-0">
            <div className="bg-[hsl(var(--paper))] p-6 shadow-lg transform -rotate-1 transition-all duration-300" 
              ...
              <Link to="/farm-and-garden/trees?type=avocado" className="text-sm text-[hsl(var(--text-accent))] font-medium ui-text hover:underline focus:underline">
                Follow its journey →
              </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
          <div className="w-full md:w-3/5 z-0">
            <ImageWrapper 
              ...
              className="w-full max-w-sm mx-auto transform -rotate-2 transition-transform duration-300"
            />
          </div>
          <div className="w-full md:w-3/5 md:-ml-24 z-10 -translate-x-2 md:translate-x-0">
            <div className="bg-[hsl(var(--paper))] p-6 shadow-lg transform rotate-2 transition-all duration-300" 
                 style={{ filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.1))' }}>
              <h3 
                className="text-2xl md:text-3xl mb-4 text-[hsl(var(--text-primary))]"
                style={{ fontFamily: 'Caveat, cursive' }}
              ...
              <Link to="/farm-and-garden/trees?type=mango" className="text-sm text-[hsl(var(--text-accent))] font-medium ui-text hover:underline focus:underline">
                Discover its story →
              </Link>
              <p className="text-xs text-[hsl(var(--stone))] font-medium ui-text mt-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
          ...
          <div className="w-full md:w-3/5 md:-ml-20 z-10 -translate-x-2 md:translate-x-0">
            <div className="bg-[hsl(var(--paper))] p-6 shadow-lg transform -rotate-2 transition-all duration-300" 
              ...
              <Link to="/farm-and-garden/trees?type=durian" className="text-sm text-[hsl(var(--text-accent))] font-medium ui-text hover:underline focus:underline">
                Uncover its secrets →
              </Link>
              <p className="text-xs text-[hsl(var(--stone))] font-medium ui-text mt-2">
