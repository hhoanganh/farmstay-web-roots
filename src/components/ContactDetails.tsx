      ...
      <div className="space-y-4">
        ...
        <div className="bg-[hsl(var(--background-primary))] p-6 rounded-lg border border-[hsl(var(--stone))] border-opacity-20 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-full border border-[hsl(var(--stone))] border-opacity-50">
        ...
        <div className="bg-[hsl(var(--background-primary))] p-6 rounded-lg border border-[hsl(var(--stone))] border-opacity-20 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-full border border-[hsl(var(--stone))] border-opacity-50 mt-1">
      ...
      <div className="pt-6 border-t border-[hsl(var(--stone))] border-opacity-20">
        ...
        <div className="flex gap-4">
          <a 
            ...
            className="p-3 rounded-full border border-[hsl(var(--stone))] border-opacity-50 hover:bg-[hsl(var(--stone))] hover:bg-opacity-20 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center focus:ring-2 focus:ring-[hsl(var(--focus))] focus:ring-offset-2"
            aria-label="Facebook"
          >
