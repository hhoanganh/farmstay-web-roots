...
>(
  (
    ...
    // Responsive sidebar: horizontal bar on mobile, vertical on desktop
    return (
      <>
        {/* Mobile: horizontal bar at the top */}
        <div
          className={cn(
            "flex flex-row w-full h-auto bg-sidebar text-sidebar-foreground border-b border-[hsl(var(--border-primary))] md:hidden",
            className
          )}
          ref={ref}
          {...props}
        ...
        <div
          className={cn(
            "hidden md:flex flex-col w-[--sidebar-width] h-full bg-sidebar text-sidebar-foreground border-r border-[hsl(var(--border-primary))]",
            className
          )}
        >
          {children}
...
>>>>>>> 69b6de6dbb36c5c1fa293a83bc414eec77655245
}
